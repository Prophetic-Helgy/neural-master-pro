...
- **Pro — realtime mixer**: Faust-based DSP engine: tonal balance (drive / lows / mids / high air), graphic EQ, stems (Master / Bass / Mid / Side), FX (autotune, reverb, distortion, delay, chorus), FX automation regions, 7 visualizer modes.
...
Proprietary — see [LICENSE](LICENSE). Free for personal, non-commercial use; redistribution, reselling and bundling are not permitted. Any audio you process with the Software is 100% yours.
...
- **Pro — realtime-микшер**: DSP-движок на Faust: тон (drive / lows / mids / high air), графический EQ, стемы (Master / Bass / Mid / Side), эффекты (autotune, reverb, distortion, delay, chorus), регионы автоматизации FX, 7 режимов визуализатора.
...
Проприетарная — см. [LICENSE](LICENSE). Бесплатно для личного некоммерческого использования; перераспространение, перепродажа и включение в другие продукты запрещены. Любое обработанное вами аудио — 100% ваше.
